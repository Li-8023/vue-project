            ...
            <div class="window">
                <div class="content">
                    ...
                    <form @submit.prevent="login">
                        ...
                        <button class="custom-button" @click="goToNext">登录</button>
                        <p v-if="showWarning" class="warning">请输入用户名或登录密码</p>
                    </form>
                </div>
            </div>
        </div>
...
export default {
  ...
  computed: {
        isValidInput() {
            return this.username && this.password; // Check if both fields are non-empty
        },
    },
  methods: {
    goToNext() {
